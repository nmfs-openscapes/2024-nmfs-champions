...
Next, make an edit to the text in this file. One idea is to fix this typo. (thank goodness that got corrected!) 
...
>Now let's practice Markdown and commit another edit to this file. (I added an indent)
